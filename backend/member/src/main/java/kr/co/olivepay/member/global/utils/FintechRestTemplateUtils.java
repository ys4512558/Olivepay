...
import kr.co.olivepay.member.openapi.handler.FintechResponseErrorHandler;
...
public class FintechRestTemplateUtils {
     ...
     */
    public <E> E postForEntity(URI uri, MemberCreateAndSearchReq request, Class<E> responseType) {
