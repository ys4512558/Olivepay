...
급식 결여 아동들이 더 편하고 거부감없이 꿈나무카드를 사용할 수 있게 하며,
쿠폰을 통한 메뉴 선택에 다양성을 제공 및 가맹점을 쉽게 조회할 수 있도록 도와줍니다.
...
1. `회원가입 & 로그인 (꿈나무 카드 등록`
   ...
   ![1.사용자-회원가입로그인.gif](./images/1.사용자-회원가입로그인.gif)

2. `사용자 카드 등록 (OCR)`

   ![2.사용자-카드등록OCR.gif](./images/2.사용자-카드등록OCR.gif)

---

3. `사용자 지도 검색 (가맹점 찜)`

   ![3.사용자-지도검색.gif](./images/3.사용자-지도검색.gif)

4. `사용자 쿠폰 획득` (최대 2개 획득 가능)

   ![4.사용자-쿠폰획득.gif](./images/4.사용자-쿠폰획득.gif)

---

5. `사용자 내 쿠폰 조회`

   ![5.사용자-내쿠폰조회.gif](./images/5.사용자-내쿠폰조회.gif)

---

6. `1) 가맹점주 결제 QR 생성`

   ![6.1가맹점주-큐알생성.gif](./images/6.1가맹점주-큐알생성.gif)

6. `2) 사용자 QR 결제`

   ![6.2사용자-큐알결제.gif](./images/6.2사용자-큐알결제.gif)

---

7. `사용자 결제 내역 조회`

   ![7.사용자-결제내역조회.gif](./images/7.사용자-결제내역조회.gif)

8. `사용자 리뷰 등록`

   ![8.사용자-리뷰등록.gif](./images/8.사용자-리뷰등록.gif)
...
2. `가맹점주 내 가게 결제 내역 확인`
   ...
   ![1.가맹점주-결제내역확인.gif](./images/1.가맹점주-결제내역확인.gif)

---

3. `가맹점주 내 가게 보유 쿠폰 확인`

   ![2.가맹점주-보유쿠폰확인.gif](./images/2.가맹점주-보유쿠폰확인.gif)
...
1. `후원자 후원`
   ...
   ![1.후원자-후원.gif](./images/1.후원자-후원.gif)

2. `후원자 후원 내역 조회`

   ![2.후원자-후원내역조회.gif](./images/2.후원자-후원내역조회.gif)
